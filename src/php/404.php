    ...
    <div class="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
        <div class="wf-ull lg:w-1/2">
            ...
            <div class="flex items-center mt-6 gap-x-3">
                ...
                <a class="cursor-hand rounded-md py-3 px-8 text-center text-base font-semibold
                outline-none items-center select-none bg-primary text-white bg-primary text-white"
                    href="../index.php">
                    Take me Home
                </a>
            </div>
        ...
        <div class="relative w-full mt-12 lg:w-1/2 lg:mt-0">
            <img class="w-full max-w-lg lg:mx-auto" src="https://merakiui.com/images/components/illustration.svg"
                 alt="">
        </div>
