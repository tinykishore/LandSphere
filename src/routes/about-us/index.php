    ...
    <div class="flex gap-6 items-center">
        ...
        <div id="dropdownAvatarName"
            ...
            <ul class="py-2 text-sm text-gray-700"
                ...
                <li>
                    <a href="../user-dashboard/booking-land" class="flex px-4 py-2 mb-2 hover:bg-gray-100 gap-3 w-full items-center">
...
<section class="container mx-auto my-auto mt-48 mb-12 pl-16 pr-16">
    <main class="grid grid-cols-2 grid-rows-1 gap-12 place-items-center">
        <div class="text-sm text-gray-600 p-4 text-center">
            At our land management system project, we strive to promote efficient and eco-friendly land management
        ...
        <div class="absolute left-1/2 -ml-0.5 w-1 h-48 bg-green-600"></div>

        <div class="flex flex-col gap-8 text-center">
            <img height="37" width="350" src="../../resource/icons/landSphere.svg" alt="">
            <h1 class="-ml-4 font-black text-xl"> &copy; 2023 <a href="#" class="text-green-600">LandSphere </a> Inc.
            </h1>
        </div>
    </main>
</section>

<div class="text-center text-zinc-700 p-12 flex flex-col">
    <h1>Made by
        <a href="https://github.com/mariamuna04" class="font-semibold text-primary">Ummay Maria Muna</a> and
        <a href="https://github.com/tinykishore" class="font-semibold text-primary">Shanto Biswas</a>
    </h1>
    <h1 class="font-light text-zinc-500">
        A project for Database Management Systems (CSE 3412, Spring-2023) course at United International University
    </h1>
</div>
